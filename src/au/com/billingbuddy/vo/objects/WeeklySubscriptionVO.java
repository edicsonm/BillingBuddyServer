...
public class WeeklySubscriptionVO extends VO implements Serializable {
	
	private static final long serialVersionUID = 5884794203212342389L;
	private String id;
    ...
    public boolean equals(Object obj) {
		if (!(obj instanceof WeeklySubscriptionVO))
			return false;
		WeeklySubscriptionVO objetoVO = (WeeklySubscriptionVO) obj;
